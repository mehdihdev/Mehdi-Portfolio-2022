        ...
        <div className="flex-row max-w-4xl mx-auto mt-16 antialiased">
            ...
            <div className="flex flex-row animate-fade-in-down">
                <div className="mr-7 mt-4">
                    <div className="rounded-lg shadow-lg max-w-sm">
                        ...
                        <p className="text-gray-700 text-base mb-4 dark:text-white">
                            ...
                            <a href='https://nchack.org' target="_blank" rel="noreferrer" className="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium leading-tight rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">See More</a>
                        </div>
                    </div>
                </div>
                <div className="mr-7 mt-4">
                <div className="rounded-lg shadow-lg max-w-sm">
                    ...
                    <a href='https://nonprofit.foundation' target="_blank" rel="noreferrer" className="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium leading-tight rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">See More</a>
                    </div>
                </div>
            </div>
            <div className="mr-7 mt-4">
                <div className="rounded-lg shadow-lg max-w-sm">
                    ...
                    <p className="text-gray-700 text-base mb-4 dark:text-white">
                        ...
                        <a href='https://apps.apple.com/us/app/iabat/id1470669636' target="_blank" rel="noreferrer" className="mb-4 inline-block px-6 py-2.5 bg-blue-600 text-white font-medium leading-tight rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">App Store</a>
                        <a href='https://apps.apple.com/us/app/iabat/id1470669636' target="_blank" rel="noreferrer" className="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium leading-tight rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">GH Repo</a>
                    </div>
                </div>
            </div>
        </div>
