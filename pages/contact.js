    ...
    return(
        <div className="max-w-4xl mx-auto mt-16 antialiased">
            ...
            <div className="flex flex-col min-h-screen">
                    <p className="mt-3">Email me at <span className="hover:underline text-yellow-500">mehdi@mehdi.us</span> or message me here:</p>
                    ...
                    <div className="grid gap-6 sm:grid-cols-2">
                        ...
                        <button type="submit" className="mt-5 rounded-full bg-indigo-500 px-10 py-2 text-white">Send Message</button>
                    </form>
                </div>
            </div>
        </div>
